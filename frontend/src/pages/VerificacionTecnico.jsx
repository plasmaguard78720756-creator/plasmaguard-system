// src/pages/VerificacionTecnico.jsx - VERSIÓN COMPLETA
import React, { useState } from 'react';
import { useNavigate, useLocation } from 'react-router-dom';
import { useAuth } from '../contexts/AuthContext';

const VerificacionTecnico = () => {
  ...
  const handleVerification = async (e) => {
    ...
    setTimeout(() => {
      ...
      if (codigo === 'Servicio1230') {
        // Código correcto - redirigir al dashboard técnico
        ...
        <div className="bg-white rounded-xl shadow-lg p-8">
          ...
          {userData && (
            <div className="bg-green-50 border border-green-200 rounded-lg p-4 mb-6">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <p className="font-semibold text-green-800">{userData.name}</p>
                  <p className="text-green-600 text-sm">Acceso: Servicio Técnico</p>
                </div>
              </div>
            </div>
          )}
          ...
          <div className="text-center mb-6">
            <div className="bg-orange-100 border border-orange-200 rounded-lg p-4 mb-4">
              ...
              <h2 className="text-xl font-bold text-orange-800 mt-2">
                Verificación de Servicio Técnico
              </h2>
              <p className="text-orange-700 mt-1">
                Usted está intentando ingresar como personal de servicio técnico
              </p>
            </div>
          </div>
          ...
          <form onSubmit={handleVerification} className="space-y-4">
            <div>
              ...
              <input
                ...
                placeholder="Ingresa el código de servicio técnico"
                autoComplete="off"
              />
              <p className="text-xs text-gray-500 mt-1">
                Código exclusivo para personal autorizado de servicio técnico
              </p>
            </div>
            ...
            <div className="flex space-x-3 pt-4">
              <button
                ...
                className="flex-1 bg-green-600 text-white py-3 px-4 rounded-lg hover:bg-green-700 transition font-medium disabled:bg-green-300 disabled:cursor-not-allowed"
              >
                {isVerifying ? (
          ...
          <div className="mt-6 p-4 bg-gray-50 border border-gray-200 rounded-lg">
            <h3 className="font-semibold text-gray-800 mb-2">🔧 Información del Servicio Técnico</h3>
            <ul className="text-sm text-gray-600 space-y-1">
              <li>• Acceso exclusivo para personal de mantenimiento autorizado</li>
              <li>• Permite controlar modos de operación del sistema</li>
              <li>• Acceso a reportes técnicos y diagnóstico de sensores</li>
              <li>• Contacta al administrador si necesitas el código</li>
            </ul>
          </div>
        </div>
      </div>
...
export default VerificacionTecnico;